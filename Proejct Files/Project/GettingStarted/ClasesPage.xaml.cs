...
public partial class ClasesPage : ContentPage
{
    ...
    private void ButtonAddClassCliked(object sender, EventArgs e)
    {
    ...
    private async void ButtonRemoveClass(object sender, EventArgs e)
    {
    ...
    private async void ButtonSaveClasses(object sender, EventArgs e)
    {
